...
class Approval_4 extends CI_Controller

{
    ...
    public function index()
    {
        ...
        $this->load->view('approval/pimpinan_4', $data);
    ...
    public function riwayat_approve()
    {
        ...
        $this->load->view('template/topbar', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('approval/riwayat_approve4', $data);
        $this->load->view('template/footer', $data);
    }
    ...
    function detail($idform)
    {
        ...
        $this->load->view('template/topbar', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('approval/detail_form4', $data);
        $this->load->view('template/footer', $data);
    }
