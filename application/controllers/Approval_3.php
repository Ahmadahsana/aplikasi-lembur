...
class Approval_3 extends CI_Controller

{
    ...
    public function index()
    {
        ...
        foreach ($data['lembur'] as $d) {
            ...
            $hasil = $this->m_lembur->get_peserta($d['id'], '3');
            foreach ($hasil as $h) {
                $peserta[] = [
                    'id' => $h['id_form'],
                    'peserta' => $h['nama_user']
        ...
        $this->load->view('approval/pimpinan_3', $data);
    ...
    public function riwayat_approve()
    {
        ...
        $this->load->view('template/topbar', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('approval/riwayat_approve3', $data);
        $this->load->view('template/footer', $data);
    }
    ...
    function detail($idform)
    {
        ...
        $this->load->view('template/topbar', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('approval/detail_form3', $data);
        $this->load->view('template/footer', $data);
    }
